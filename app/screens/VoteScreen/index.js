...
const VoteScreen = ({route}) => {
    ...
    return (
        <View style={{marginTop: Constants.statusBarHeight, alignItems: 'center'}}>
            <View style={{height: height*0.05, justifyContent: 'center', alignItems: 'center', marginTop: height*0.018, width: '100%'}}>
            ...
            <View style={{flexDirection: 'row', height: height*0.03, justifyContent: 'center', marginBottom: 20}}>
